...
public:
    ...
    void hal_name()
    {
        switch(obn)
        {
            ...
            break;
             case 2:
            hall_name="CINEPOLIS, New Town (In Acropolis Mall)";
            break;
             case 3:
            hall_name="PVR Cinemas(Diamond Plaza), Salt Lake";
            break;
             case 4:
            hall_name="Nandan Cenema Hall 1, Exide";
            break;
        }
...
void movie_booking::ticket_print()
{
    ...
    char res1;
    // cout<<"Enter Y/y to Show Total Cost Resipt : "<<endl;
...
int main()
{
    ...
    cout<<"\n\n\t\t\t\t\t\t\t PRESS 2 TO BOOK TICKET IN : CINEPOLIS, New Town (In Acropolis Mall)";
    cout<<"\n\n\t\t\t\t\t\t\t PRESS 3 TO BOOK TICKET IN : PVR Cinemas(Diamond Plaza), Salt Lake ";
    cout<<"\n\n\t\t\t\t\t\t\t PRESS 4 TO BOOK TICKET IN : Nandan Cenema Hall 1, Exide";
    ...
    switch(obn)
    {
        ...
        case 2:
        cout<<"\t\t\t\t\t\t\t";
            cout<<"CINEPOLIS, New Town (In Acropolis Mall) IS SELECTED\n";
        obj[1].first();
        break;
        case 3:
        cout<<"\t\t\t\t\t\t\t";
             cout<<"PVR Cinemas(Diamond Plaza), Salt Lake IS SELECTED\n";
        obj[2].first();
        break;
        case 4:
        cout<<"\t\t\t\t\t\t\t";
            cout<<"Nandan Cenema Hall 1, Exide IS SELECTED\n";
        obj[3].first();
        break;
        case 9:
                goto bye;
